...
import coronadash.lib.encoders
import os
import logging
import datetime
...
server_settings = {
    ...
    "cookie_secret"     :   "e6048289-675e-4be8-9fe4-f05631b86cbb"
}
...
myapp = {
    ...
    "default_format"    :   "json",
    "encoder"           :   {
           "json"   :   coronadash.lib.encoders.json_to_json(),
            "csv"   :   coronadash.lib.encoders.json_to_csv(),
            "xml"   :   coronadash.lib.encoders.json_to_xml()
    },
    "byte_decoding"     :   "utf-8",
