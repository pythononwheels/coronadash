...
#
from coronadash.conf.config import database, myapp
...
#from coronadash.models.sql.basemodel import SqlBaseModel
from coronadash.models.sql.sqlmodel import SqlModel
