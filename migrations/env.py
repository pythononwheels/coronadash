...
from coronadash.lib.powlib import get_class_name
from coronadash.conf.config import myapp
from coronadash.lib.application import log_handler
import logging
...
import importlib
for m in mods:
    mod = importlib.import_module('coronadash.models.sql.' + m)
...
#from coronadash.dblib import Base
